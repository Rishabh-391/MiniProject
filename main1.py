...
loaded_model = pickle.load(open('heartDiease_model', 'rb'))
...
def Get_input():
    ...
    x = Predict(lis1)
    if x == 0:
        Output.insert(END, "The Person Has Healthy Heart")
        print("The Person Has Healthy Heart")
    else:
        Output.insert(END, "The Person has Unhealthy Heart")
        print("The Person has Unhealthy Heart")
